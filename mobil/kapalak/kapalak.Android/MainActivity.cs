...
using kapalak.AppPackage;
using BlazorMobile.Droid.Platform;

namespace kapalak.Droid
{
    [Activity(Label = "kapalak", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
